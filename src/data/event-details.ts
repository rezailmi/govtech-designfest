...
export const eventDetails: Record<string, EventDetail> = {
  ...
  "Find my center- how our body, emotions & language shape the observer we are": {
    ...
    speakerBio: "**About Sarah Xu**\n\nSarah is an Industrial/Organisational Psychologist currently in the role of Organisation Development Partner at GovTech supporting the organisation's transformation efforts.\n\nPrior to this, she spent 10+ years in People Analytics and some time in user experience for talent platforms in the private sector.\n\n\n**About Low Jin Wei**\n\nLow Jin Wei is a HR practitioner and coach guided by the north star to optimise people performance at organisational and individual level. The 3 key pillars of his professional career include: (1) HR, where he designs and implements people strategies to create high performing organisations; (2) Coaching, where he facilitates meaningful conversations for high-performing individuals to help them uncover clarity in a world where change is the only constant; and (3) Body-mind fitness, where he coaches individuals to embody a healthy body and mind necessary for high performance through his years of training as a physical fitness and yoga coach."
  },
